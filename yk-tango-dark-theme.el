...
;;;;; `tabbar' — Display a tab bar in the header line
  ...
  `(tabbar-unselected ((default . (:inherit tabbar-default))
                       (((min-colors 16777216)) . (:background ,aluminium02
                                                   :box (:line-width 1 :color ,aluminium02)))))
  ...
  `(tabbar-selected ((default . (:inherit tabbar-unselected :foreground unspecified :box nil))
...
;;;;; `Dired-Plus'
  ...
  `(diredp-dir-name ((default . (:inherit dired-directory))))
  `(diredp-autofile-name ((default . (:inherit bm-face))
                          (((min-colors 16777216)) . (:background ,chocolate-bg))))
  `(diredp-tagged-autofile-name ((default . (:inherit bm-persistent-face))
                                 (((min-colors 16777216)) . (:background ,orange-bg))))
  `(diredp-compressed-file-name ((((min-colors 16777216)) . (:foreground ,plum4))
                                 (((min-colors 256)) . (:foreground ,rgb323))))
  `(diredp-compressed-file-suffix ((default . (:inherit diredp-compressed-file-name))))
